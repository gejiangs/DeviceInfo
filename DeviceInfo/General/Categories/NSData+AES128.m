...
- (NSData *)AES128EncryptWithKey:(NSString *)key
{
    ...
    NSString *dataString = [self.description stringByReplacingOccurrencesOfString:@"<" withString:@""];
    dataString = [dataString stringByReplacingOccurrencesOfString:@">" withString:@""];
    dataString = [dataString stringByReplacingOccurrencesOfString:@" " withString:@""];
    
    [self convertString:key bytes:cKey];
    [self convertString:dataString bytes:cValue];
